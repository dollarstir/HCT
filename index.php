...
<html lang="en">
<head>
    <title>HALIDAS COLLEGE -HOME</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body class="home-page">
    <div class="wrapper">
                ...
                <div class="container">     
	                <div class="row">   
	                    <ul class="social-icons col-md-6 col-12 d-none d-md-block">
	                        ...
	                        <li class="row-end"><a href="index.html#" ><i class="fas fa-rss"></i></a></li>             
	                    </ul><!--//social-icons-->
            ...
            <div class="header-main container">
	            <div class="row">
	                <h1 class="logo col-md-4 col-12">
	                    <a href="index.php"><img id="logo" src="assets/images/log2.png" alt="Logo" width="90px" height="60px"><br><h4>Halidas College Of Technology</h4></a>
	                </h1><!--//logo-->           
	                <div class="info col-md-8 col-12">
	                    <ul class="menu-top float-right d-none d-md-block">
	                        ...
	                        <li><a href="contact.html">Admin login</a></li>
	                    </ul><!--//menu-top-->
	                    <br />
	                    <div class="contact float-right">
	                        <p class="phone"><i class="fas fa-phone"></i>Call us today 0547501699</p> 
	                        <p class="email"><i class="fas fa-envelope"></i><a href="index.html#">halidas99@gmail.com</a></p>
	                    </div><!--//contact-->
	                </div><!--//info-->
	            </div><!--//row-->
            </div><!--//header-main-->
	                    ...
	                    <ul class="nav navbar-nav">
	                        ...
	                        <!-- <li class="nav-item dropdown">
	                            ...
	                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	                                ...
	                                <a class="dropdown-item" href="#">Single Course (with image)</a>
	                                <a class="dropdown-item" href="#">Single Course (with video)</a>                
	                            </div>
	                        </li> -->
	                        <li class="nav-item dropdown">
	                            ...
	                            <div class="dropdown-menu" aria-labelledby="navbarDropdown-2">
	                                ...
	                                <a class="dropdown-item" href="#">Single News (with image)</a>   
	                                <a class="dropdown-item" href="#">Single News (with video)</a>         
	                            </div>
	                        </li>
	                        ...
	                        <!-- <li class="nav-item dropdown">
	                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false" href="index.html#">Pages <i class="fas fa-angle-down"></i></a>
                            ...
                            <li class="nav-item dropdown">
	                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown-2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Admission <i class="fas fa-angle-down"></i></a>
	                            <div class="dropdown-menu" aria-labelledby="navbarDropdown-2">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#">Results Checker</a></li>
                            <li class="nav-item"><a class="nav-link" href="about.php">About Us</a></li>
	                        
                            <li class="nav-item"><a class="nav-link" href="contact.php">Contact</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Student Portal</a></li>
	                    </ul><!--//nav-->
	                </div><!--//navabr-collapse-->
        ...
        <div class="content container">
            <div id="promo-slider" class="slider flexslider">
                <ul class="slides">
                    <li>
                        <img src="assets/images/slides/sd1.jpg"  alt="" />
                        <p class="flex-caption">
                            <span class="main" >Join Halidas College  Online</span>
                            <br />
                            <!-- <span class="secondary clearfix" >Choose from over 100 online and offline courses</span> -->
                        </p>
                    </li>
                    <li>
                        <img src="assets/images/slides/sd3.jpg"  alt="" />
                        <p class="flex-caption">
                            <span class="main" >Come Join US Now</span>
                            <br />
                            <!-- <span class="secondary clearfix" >Donec accumsan nunc sed ipsum dapibus consectetur</span> -->
                        </p>
                    </li>
                    <li>
                        <img src="assets/images/slides/sd4.jpg"  alt="" />
                        <p class="flex-caption">
                    ...
                    <li>
                        <img src="assets/images/slides/sd5.jpg"  alt="" />
                        <p class="flex-caption">
                            <span class="main" >Graduation</span>
                            <br />
                    ...
                    <li>
                        <img src="assets/images/slides/slide9.jpg"  alt="" />
                        <p class="flex-caption">
                            <span class="main" >Lectures</span>
                            <br />
                            <!-- <span class="secondary clearfix" >In justo orci, ornare vitae nulla sed, suscipit suscipit augue</span> -->
                        </p>
                    </li>
            ...
            <section class="promo box box-dark">     
	            <div class="row">  
	                ...
	                <h1 class="section-heading">Why  Halidas College</h1>
	                    <p>We have Quality and wel-trained tutors. We also teach both theory and practicals. We provide wel-equiped computer laboratory </p>   
	                </div>  
            ...
            <section class="news">
                ...
                <div class="carousel-controls">
                    <a class="prev" href="index.php#news-carousel" data-slide="prev"><i class="fas fa-caret-left"></i></a>
                    <a class="next" href="index.php#news-carousel" data-slide="next"><i class="fas fa-caret-right"></i></a>
            ...
            <div class="row cols-wrapper">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <section class="video">
                        ...
                        <div class="carousel-controls">
                            <a class="prev" href="index.html#videos-carousel" data-slide="prev"><i class="fas fa-caret-left"></i></a>
                            <a class="next" href="index.html#videos-carousel" data-slide="next"><i class="fas fa-caret-right"></i></a>
                        </div><!--//carousel-controls-->
                        <div class="section-content">    
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item item active">    
	                                    <div class="embed-responsive embed-responsive-16by9 mb-2">        
	                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/r9LelXa3U_I?rel=0&wmode=transparent" frameborder="0" allowfullscreen=""></iframe>
	                                    </div>
                                    </div><!--//item-->
                                    <div class="carousel-item item">            
                                        <div class="embed-responsive embed-responsive-16by9 mb-2">        
	                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/RcGyVTAoXEU?rel=0&wmode=transparent" frameborder="0" allowfullscreen=""></iframe>
	                                    </div>
                                    </div><!--//item-->
                                    <div class="carousel-item item">
                                        <div class="embed-responsive embed-responsive-16by9 mb-2">        
	                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Ks-_Mh1QhMc?rel=0&wmode=transparent" frameborder="0" allowfullscreen=""></iframe>
	                                    </div>
                                    </div><!--//item-->
                                </div><!--//carousel-inner-->
                           </div><!--//videos-carousel-->                            
                ...
                <div class="col-lg-3 col-12">
                    <section class="links">
                        ...
                        <div class="section-content">
                            ...
                            <p><a href="#"><i class="fas fa-caret-right"></i>Apply Now</a></p>
                            <p><a href="#"><i class="fas fa-caret-right"></i>Result Checker</a></p>
                    ...
                    <section class="testimonials">
                        ...
                        <div class="carousel-controls">
                            <a class="prev" href="index.php#testimonials-carousel" data-slide="prev"><i class="fas fa-caret-left"></i></a>
                            <a class="next" href="index.php#testimonials-carousel" data-slide="next"><i class="fas fa-caret-right"></i></a>
                        </div><!--//carousel-controls-->
                        <div class="section-content">
                ...
                <div id="awards-carousel" class="awards-carousel carousel slide">
                    <div class="carousel-inner">
                        <div class="carousel-item item active">
                            <ul class="logos row">
                                ...
                                <li class="col-md-2 col-4">
                                    <a href="index.html#"><img class="img-fluid" src="assets/images/awards/award1.jpg"  alt="" /></a>
                                </li>
                                <li class="col-md-2 col-4">
                                    <a href="index.html#"><img class="img-fluid" src="assets/images/awards/award2.jpg"  alt="" /></a>
                                </li>
                                <li class="col-md-2 col-4">
                                    <a href="index.html#"><img class="img-fluid" src="assets/images/awards/award3.jpg"  alt="" /></a>
                                </li>
                                <li class="col-md-2 col-4">
                                    <a href="index.html#"><img class="img-fluid" src="assets/images/awards/award4.jpg"  alt="" /></a>
                                </li>
                                <li class="col-md-2 col-4">
                                    <a href="index.html#"><img class="img-fluid" src="assets/images/awards/award5.jpg"  alt="" /></a>
                                </li>
                                <li class="col-md-2 col-4">
                                    <a href="index.html#"><img class="img-fluid" src="assets/images/awards/award6.jpg"  alt="" /></a>
                                </li>             
                            </ul><!--//slides-->
                        </div><!--//item-->
                        ...
                        <div class="carousel-item item">
                            <ul class="logos row">
                                <li class="col-md-2 col-4">
                                    <img class="img-fluid" src="assets/images/awards/award7.jpg"  alt="" />
                                </li>
                                <li class="col-md-2 col-4">
                                    <img class="img-fluid" src="assets/images/awards/award6.jpg"  alt="" />
                                </li>
                                <li class="col-md-2 col-4">
                                    <img class="img-fluid" src="assets/images/awards/award5.jpg"  alt="" />
                                </li>
                                <li class="col-md-2 col-4">
                                    <img class="img-fluid" src="assets/images/awards/award4.jpg"  alt="" />
                                </li>
                                <li class="col-md-2 col-4">
                                    <img class="img-fluid" src="assets/images/awards/award3.jpg"  alt="" />
                                </li>
                                <li class="col-md-2 col-4">
                                    <img class="img-fluid" src="assets/images/awards/award2.jpg"  alt="" />
                                </li>             
                            </ul><!--//slides-->
                        </div><!--//item-->
                    </div><!--//carousel-inner-->
    ...
    <footer class="footer">
                        ...
                        <div class="row">
                            <p class="adr clearfix col-lg-12 col-md-4 col-12">
                                ...
                                <span class="adr-group float-left">       
                                    <span class="street-address"> Halidas College </span><br>
                                    <span class="region">Garu, Upper East Region</span><br>
                                    <!-- <span class="postal-code">BS16 AP18</span><br> -->
                                    <span class="country-name">Ghana</span>
                                </span>
                            </p>
                            <p class="tel col-lg-12 col-md-4 col-12"><i class="fas fa-phone"></i>0547501699</p>
                            <p class="email col-lg-12 col-md-4 col-12"><i class="fas fa-envelope"></i><a href="#">halidas99@gmail.com</a></p>  
                        </div> 
                    </div><!--//footer-col-inner-->            
                </div><!--//foooter-col-->   
                </div>   
        ...
        <div class="bottom-bar">
            <div class="container">
                <div class="row">
                    <small class="copyright col-lg-6 col-12"> Copyright &copy; <?php echo date("Y"); ?><a href="#">Halidas College </a></small>
